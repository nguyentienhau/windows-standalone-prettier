...
var vt = (a, t, e) => ((e = a != null ? $s(zs(a)) : {}), Js(t || !a || !a.__esModule ? je(e, "default", { value: a, enumerable: !0 }) : e, a));
var At = Hs((xe) => {
	"use strict";
	...
	var Lt = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED",
		...
		Ce = (a) => (a.type === "UpdateExpression" ? Dt.UpdateExpression[`${a.prefix}`] : Dt[a.type]),
		Gs = {
