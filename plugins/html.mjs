...
var $e = di;
var gi = new Set(["sourceSpan", "startSourceSpan", "endSourceSpan", "nameSpan", "valueSpan", "keySpan", "tagDefinition", "tokens", "valueTokens", "switchValueSourceSpan", "expSourceSpan", "valueSourceSpan"]),
...
function Di(t, e) {
	let r = t.plugins.flatMap((s) => s.languages ?? []),
		n = Ai(r, e.language) ?? Sn(r, e.physicalFile) ?? Sn(r, e.file) ?? (e.physicalFile, void 0);
...
function bn(t, e) {
	...
	return r;
	function n() {
		return $e(t) || t.type === "angularControlFlowBlock" ? !1 : (t.type === "text" || t.type === "interpolation") && t.prev && (t.prev.type === "text" || t.prev.type === "interpolation") ? !0 : !t.parent || t.parent.cssDisplay === "none" ? !1 : _e(t.parent) ? !0 : !((!t.prev && (t.parent.type === "root" || (_e(t) && t.parent) || U(t.parent) || Je(t.parent, e) || !Li(t.parent.cssDisplay))) || (t.prev && !Pi(t.prev.cssDisplay)));
	}
}
function Tn(t, e) {
	return $e(t) || t.type === "angularControlFlowBlock" ? !1 : (t.type === "text" || t.type === "interpolation") && t.next && (t.next.type === "text" || t.next.type === "interpolation") ? !0 : !t.parent || t.parent.cssDisplay === "none" ? !1 : _e(t.parent) ? !0 : !((!t.next && (t.parent.type === "root" || (_e(t) && t.parent) || U(t.parent) || Je(t.parent, e) || !Fi(t.parent.cssDisplay))) || (t.next && !Ni(t.next.cssDisplay)));
}
function xn(t) {
...
function kn(t) {
	return dr(t) || (t.type === "element" && t.children.length > 0 && (["body", "script", "style"].includes(t.name) || t.children.some((e) => Ti(e)))) || (t.firstChild && t.firstChild === t.lastChild && t.firstChild.type !== "text" && Ln(t.firstChild) && (!t.lastChild.isTrailingSpaceSensitive || Fn(t.lastChild)));
}
function dr(t) {
...
var Wn = Ki;
function Qi(t) {
	if (t.node.fullName === "srcset" && (t.parent.fullName === "img" || t.parent.fullName === "source")) return () => Ji(P(t.node));
}
var zn = { width: "w", height: "h", density: "x" },
	Xi = Object.keys(zn);
function Ji(t) {
	let e = Wn(t),
		r = Xi.filter((l) => e.some((f) => Object.prototype.hasOwnProperty.call(f, l)));
...
function ta(t, e) {
	...
	if (n.startsWith("@") || n.startsWith("v-on:")) return (a) => ra(s, a, { parseWithTs: i });
...
function ca(t, e, r) {
	...
	let s = ((f = n.prev) == null ? void 0 : f.type) === "comment" && la(n.prev.value),
...
function ps(t, e, r) {
	let { node: n } = t,
		s = [];
	_a(t) && s.push("} "), s.push("@", n.name), n.parameters && s.push(" (", _(r("parameters")), ")"), s.push(" {");
	let i = hs(n);
...
function Ws(t, e, r, n = {}) {
	...
	return s.tokenize(), new $r(_o(s.tokens), s.errors, s.nonNormalizedIcuExpressions);
}
var po = /\r\n?/g;
function je(t) {
...
var dt = class {
	...
	Or = class {
		constructor(e, r, n) {
			...
			(this._cursor = n.escapedString ? new Mr(e, s) : new rr(e, s)), (this._preserveLineEndings = n.preserveLineEndings || !1), (this._i18nNormalizeLineEndingsInICUs = n.i18nNormalizeLineEndingsInICUs || !1), (this._tokenizeBlocks = n.tokenizeBlocks ?? !0), (this._tokenizeLet = n.tokenizeLet ?? !0);
			try {
				this._cursor.init();
			} catch (i) {
				this.handleError(i);
...
`,
		...
		_consumeEntity(e) {
			...
			if ((this._cursor.advance(), this._attemptCharCode(35))) {
				...
				let n = this._cursor.clone();
				if ((this._attemptCharCodeUntilFn(go), this._cursor.peek() != 59)) this._beginToken(e, r), (this._cursor = n), this._endToken(["&"]);
				else {
		...
		_consumePrefixAndName() {
			let e = this._cursor.clone(),
				r = "";
			for (; this._cursor.peek() !== 58 && !mo(this._cursor.peek()); ) this._cursor.advance();
			let n;
...
var $o = { html: As };
var Ih = Yr;
export { Ih as default, Ds as languages, ys as options, Gr as parsers, $o as printers };
