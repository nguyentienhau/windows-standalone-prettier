...
var Ue = (e, r, t) => ((t = e != null ? el(nl(e)) : {}), ul(r || !e || !e.__esModule ? ft(t, "default", { value: e, enumerable: !0 }) : t, e));
var xr = C((Om, In) => {
	"use strict";
	In.exports = sl;
	function sl(e) {
				...
				if (!(S === void 0 || O === S || g.charCodeAt(q++) !== pf)) {
					...
					for (R = g.slice(O, S), P = b.now(), Z = 0, Q = 0, me = q, Fe = []; q < k; ) {
						if (((_ = g.charCodeAt(q)), _ !== _ || _ === Rr))
							...
							if (_ === Ye || _ === lr) (Q += _ === Ye ? 1 : zr - (Q % zr)), Q > zr && ((Q = void 0), (me = q));
							else {
								if (Q < zr && z && (z.contentStart === z.contentEnd || Cf(v, a, x, [b, g.slice(q, hf), !0]))) break;
								(Q = void 0), (me = q);
							}
						q++;
					}
	...
	function Bf(e, r) {
		...
		function u(i, o, s) {
			...
			if ((o.charCodeAt(D) === Ri && ((f = !0), D++), o.charCodeAt(D) === Mr)) {
				...
				if ((o.charCodeAt(D) === Mr && ((c = !0), D++), (d = o.charCodeAt(D)), !(d === Ni || d === Ii))) {
					for (m = D; D < l; ) {
...
`,
	...
	function ip(e, r, t) {
		...
		if (i) return t ? !0 : e(u)({ type: "code", lang: null, meta: null, value: rp(i) });
	}
});
var ma = C((Yv, ha) => {
	"use strict";
...
`,
		...
		Vp = /^( {1,4}|\t)?/gm;
	function jp(e, r, t) {
		for (var n = this, a = n.options.commonmark, u = n.options.pedantic, i = n.blockTokenizers, o = n.interruptList, s = 0, l = r.length, c = null, f, D, h, p, d, m, F, y, E, B, b, g, A, x, v, w, k, q, T, R = !1, O, S, _, P; s < l && ((p = r.charAt(s)), !(p !== Jr && p !== de)); ) s++;
...
`,
	...
	function Kd(e, r, t) {
		...
		if (n.options.gfm) {
			...
			for (o = c.join(Zr), u = c.splice(1, 1)[0] || [], a = 0, l = u.length, E--, i = !1, p = []; a < l; ) {
			...
			if ((i !== !1 && p.push(i), !(p.length < jd))) {
				...
				for (
					...
					for (B = c[y], s = { type: "tableRow", children: [] }, y && e(Zr), e(B).reset(s, g), l = B.length + 1, a = 0, f = "", d = "", m = !0; a < l; ) {
				...
				if (((c = r.charAt(i)), !(!o || c !== nn)))
					return t
						...
						: ((l += o),
							...
							f.column++,
							f.offset++,
							s && (l.slice(0, et).toLowerCase() === an ? ((D = D.slice(et)), (f.column += et), (f.offset += et)) : (l = an + l)),
...
var ys = C((yE, bs) => {
	...
	function Cs(e, r, t) {
		var n = this,
			...
			l,
			c;
		if (!(!n.options.gfm || r.charAt(0) !== ut || r.charAt(1) !== ut || vs(r.charAt(2))))
...
var rc = C((OE, ec) => {
	...
	var ot = Object.prototype.hasOwnProperty,
		...
		Js = function (r) {
			...
			var t = ot.call(r, "constructor"),
				n = r.constructor && r.constructor.prototype && ot.call(r.constructor.prototype, "isPrototypeOf");
	...
	ec.exports = function e() {
		var r,
			...
			l = arguments.length,
			c = !1;
		for (typeof o == "boolean" && ((c = o), (o = arguments[1] || {}), (s = 2)), (o == null || (typeof o != "object" && typeof o != "function")) && (o = {}); s < l; ++s) if (((r = arguments[s]), r != null)) for (t in r) (n = Qs(o, t)), (a = Qs(r, t)), o !== a && (c && a && (Js(a) || (u = Ks(a))) ? (u ? ((u = !1), (i = n && Ks(n) ? n : [])) : (i = n && Js(n) ? n : {}), Xs(o, { name: t, newValue: e(c, i, a) })) : typeof a < "u" && Xs(o, { name: t, newValue: a }));
		return o;
	};
});
var nc = C((PE, tc) => {
...
var Ic = C((VE, Lc) => {
	...
	function Pc() {
		...
		function s(m) {
			...
			function b(g, A) {
				var x = l(g);
				x ? (qc(x[1]) && qc(A) && (A = ct(!0, x[1], A)), (x[1] = A)) : e.push(Dm.call(arguments));
			}
		}
		function l(m) {
...
`,
			...
			case J: {
				...
				let x = { ind: D, mode: h, doc: Ee(m) },
					v = m[0];
				Ir({ ind: D, mode: ne, doc: [F, y, v] }, [], d, l.length > 0, t, !0) ? i.push(x, g, E) : b ? i.push(x, A, E) : i.push(x, A, B);
				break;
			}
			case X:
			case se: {
...
`,
		...
		case "definition": {
			...
			return ze([bt(n), ":", Ze([i, Ct(n.url), n.title === null ? "" : [i, Nr(n.title, r, !1)]])]);
		}
		case "footnote":
			return ["[^", V(e, r, t), "]"];
...
var qm = { mdast: Ti };
var fC = Pn;
export { fC as default, _i as languages, Si as options, On as parsers, qm as printers };
