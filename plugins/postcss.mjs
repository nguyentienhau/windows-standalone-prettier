...
var ye = (t, e, s) => ((s = t != null ? al(cl(t)) : {}), pl(e || !t || !t.__esModule ? Ur(s, "default", { value: t, enumerable: !0 }) : s, t));
var Ut = y((tv, ts) => {
	"use strict";
	...
	var { SourceMapConsumer: Ac, SourceMapGenerator: Nc } = Ki(),
		...
		Pe = class {
			...
			error(e, s, r, n = {}) {
				...
				return (
					u ? (i = new eo(e, u.endLine === void 0 ? u.line : { column: u.column, line: u.line }, u.endLine === void 0 ? u.column : { column: u.endColumn, line: u.endLine }, u.source, u.file, n.plugin)) : (i = new eo(e, o === void 0 ? s : { column: r, line: s }, o === void 0 ? r : { column: a, line: o }, this.css, this.file, n.plugin)),
					(i.input = {
						column: r,
						endColumn: a,
						endLine: o,
					...
					this.file && (Kt && (i.input.url = Kt(this.file).toString()), (i.input.file = this.file)),
					i
				);
			}
			fromOffset(e) {
...
`)),
							...
							(d = f),
							(m = n))
						: ((br.lastIndex = m + 1), br.test(s), br.lastIndex === 0 ? (n = s.length - 1) : (n = br.lastIndex - 2), e.push(["word", s.slice(m, n + 1), d, m - h, d, n - h, m]), (m = n));
					break;
			}
			m++;
		}
...
var Ey = { postcss: fi };
var Ob = Qs;
export { Ob as default, pi as languages, di as options, Ks as parsers, Ey as printers };
