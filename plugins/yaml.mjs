...
var rr = (t, e, n) => ((n = t != null ? Ai(Mi(t)) : {}), vi(e || !t || !t.__esModule ? nn(n, "default", { value: t, enumerable: !0 }) : n, t));
var le = ee((U) => {
	"use strict";
	var re = {
			ANCHOR: "&",
...
function eo(t, e, n) {
	...
	let a = "";
	return (
		G(r, ["mapping", "sequence", "comment", "directive", "mappingItem", "sequenceItem"]) && !Lt(t) && (a = Tt(t, e.originalText)),
		...
		H(r) && !G(r, ["document", "documentHead"]) && s.push(ar([r.type === "mappingValue" && !r.content ? "" : " ", t.parent.type === "mappingKey" && t.getParentNode(2).type === "mapping" && ot(r) ? "" : bt, n("trailingComment")])),
		gn(r) &&
			s.push(
...
function to(t, e, n) {
	...
	switch (r.type) {
		...
		case "quoteSingle": {
			...
			if (o.includes(i)) return [s, at(r.type, r.type === "quoteDouble" ? yt(!1, yt(!1, o, String.raw`\"`, i), "'", s.repeat(2)) : o, e), s];
