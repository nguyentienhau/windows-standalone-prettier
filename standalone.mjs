...
var Me = (e, t, r) => ((r = e != null ? yu(wu(e)) : {}), ar(t || !e || !e.__esModule ? He(r, "default", { value: e, enumerable: !0 }) : r, e)),
	...
	diff: function (t, r) {
		...
		function A() {
			for (var h = Math.max(m, -l); h <= Math.min(E, l); h += 2) {
				...
				if ((!yt || ($ && k.oldPos + 1 < v.oldPos) ? (C = i.addToPath(v, !0, void 0, 0)) : (C = i.addToPath(k, void 0, !0, 1)), (F = i.extractCommon(C, r, t, h)), C.oldPos + 1 >= D && F + 1 >= a)) return s(Su(i, C.lastComponent, r, t, i.useLongestToken));
...
`,
			...
			case S: {
				...
				let $ = { ind: f, mode: p, doc: Ge(m) },
					ye = m[0];
				et({ ind: f, mode: J, doc: [E, A, ye] }, [], F, D.length > 0, r, !0) ? i.push($, k, w) : C ? i.push($, v, w) : i.push($, v, h);
				break;
			}
			case _:
			case R: {
...
function io(e, t, r) {
	...
	return !a || (r != null && r.hasLineSuffix) ? { doc: [xe([" ", o]), de], isBlock: a, hasLineSuffix: !0 } : { doc: [" ", o], isBlock: a, hasLineSuffix: !1 };
}
function so(e, t) {
	let r = e.node;
	if (!r) return {};
...
function ot({ plugins: e = [], showDeprecated: t = !1 } = {}) {
	...
	for (let o of lo(Object.assign({}, ...e.map(({ options: u }) => u), rn)))
		(!t && o.deprecated) ||
			(Array.isArray(o.choices) && (t || (o.choices = o.choices.filter((u) => !u.deprecated)), o.name === "parser" && (o.choices = [...o.choices, ...Do(o.choices, r, e)])),
...
var Et = class {
	constructor(t, r) {
		let { logger: n = console, loggerPrintWidth: o = 80, descriptor: u = wn, unknown: i = xn, invalid: s = _n, deprecated: a = vn, missing: D = () => !1, required: l = () => !1, preprocess: d = (p) => p, postprocess: f = () => he } = r || {};
		(this._utils = {
			descriptor: u,
			logger: n || { warn: () => {} },
			loggerPrintWidth: o,
		...
		for (let i of o) {
			...
			let D = ({ from: p, to: c }) => {
				...
				l = ({ value: p, redirectTo: c }) => {
					...
					if (F !== !1)
						if (F === !0) this._hasDeprecationWarned(i) || this._utils.logger.warn(this._deprecatedHandler(i, c, this._utils));
						else
...
var Qn = new Set(["JsonRoot", "ObjectExpression", "ArrayExpression", "StringLiteral", "NumericLiteral", "BooleanLiteral", "NullLiteral", "UnaryExpression", "TemplateLiteral"]),
	Vo = new Set(["OperationDefinition", "FragmentDefinition", "VariableDefinition", "TypeExtensionDefinition", "ObjectTypeDefinition", "FieldDefinition", "DirectiveDefinition", "EnumTypeDefinition", "EnumValueDefinition", "InputValueDefinition", "InputObjectTypeDefinition", "SchemaDefinition", "OperationTypeDefinition", "InterfaceTypeDefinition", "UnionTypeDefinition", "ScalarTypeDefinition"]);
function Zn(e, t, r) {
	if (!t) return !1;
	switch (e.parser) {
		case "flow":
...
function oi(e, t, r) {
	let n = t === '"' ? "'" : '"',
		u = ne(!1, e, /\\(.)|(["'])/gsu, (i, s, a) => (s === n ? s : a === t ? "\\" + a : a || (r && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/u.test(s) ? s : "\\" + s)));
	return t + u + t;
}
var hu = oi;
function ii(e, t, r) {
...
var fc = ir;
export { di as __debug, fi as check, fc as default, nr as doc, gu as format, Cu as formatWithCursor, pi as getSupportInfo, or as util, fu as version };
